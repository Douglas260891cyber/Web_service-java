...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		User u3 = new User(null, "Maria Luisa", "malui@gmail.com", "966666666", "123456");

		Order o1 = new Order(null, Instant.parse("2022-07-20T19:53:07Z"), OrderStatus.PAID, u1);
		...
		OrderItem oi1 = new OrderItem(p5, o3, 2, p1.getPrice());
